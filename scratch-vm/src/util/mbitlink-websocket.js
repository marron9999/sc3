...
class MbitLinkWebSocket {
    ...
    open () {
        ...
        case 'BLE':
            ...
            this._ws = new WebSocket('ws://device-manager.scratch.mit.edu:20111/scratch/ble');
            break;
        case 'BT':
            //this._ws = new WebSocket('wss://device-manager.scratch.mit.edu:20110/scratch/bt');
            this._ws = new WebSocket('ws://device-manager.scratch.mit.edu:20111/scratch/bt');
            break;
        default:
...
module.exports = MbitLinkWebSocket;
